...
from globals import GENSHIN_MYSQL_DB_HOST, GENSHIN_MYSQL_DB_USERNAME, GENSHIN_MYSQL_DB_PASSWORD
...
class GenshinResinCheckCommand(Command):
	...
	def execute(self, bot, messageData):
		...
		if len(args) > 0 and args[0] == "register":
			...
			bot.send_message(messageData.channel, f"{messageData.user}, successfully registered your HoyoLAB cookies. You may now use the command without any params to retrieve your Genshin in-game data.")
			return
